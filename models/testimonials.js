...
const testimonialsPageSchema = new mongoose.Schema(
  {
    ...
    pageDescription: {
      type: String,
      default:
        "At Jhapali Samaj USA, our work would not be possible without the generosity and commitment of donors, volunteers, and partner organizations. Their unwavering support has helped us provide education, healthcare, and disaster relief to thousands in Nepal.",
    },
