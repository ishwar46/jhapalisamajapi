...
exports.getProgramsPage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error fetching programs page.' });
    }
};
...
exports.updateProgramsPage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error updating programs page.' });
    }
};
...
exports.updateProgramItem = async (req, res) => {
    try {
        ...
        if (fullDescription !== undefined) programItem.fullDescription = fullDescription;
        ...
        return res.status(500).json({ error: 'Server error updating program item.' });
    }
};
...
exports.deleteProgramItem = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error deleting program item.' });
    }
};
