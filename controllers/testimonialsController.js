...
const testimonialUploader = createUploader('testimonials').single('testimonialImage');
...
exports.getTestimonialsPage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error fetching testimonials page.' });
    }
};
...
exports.updateTestimonialsPage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error updating testimonials page.' });
    }
};
