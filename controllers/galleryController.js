...
exports.addImageToGallery = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error adding image to gallery.' });
    }
};
...
exports.updateGalleryImage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error updating gallery image.' });
    }
};
...
exports.deleteGalleryImage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: 'Server error deleting gallery image.' });
    }
};
