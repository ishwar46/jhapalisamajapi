...
exports.getHearseVehiclePage = async (req, res) => {
    try {
        let page = await HearseVehiclePage.findOne()
            .populate("contributions.contributor", "fullName email");
        if (!page) {
        ...
        return res.status(500).json({ error: "Server error fetching hearse vehicle page." });
    }
};
...
exports.updateHearseVehiclePage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error updating hearse vehicle page." });
    }
};
...
exports.addContribution = async (req, res) => {
    try {
        ...
        await page.save();
        page = await HearseVehiclePage.findOne().populate("contributions.contributor", "fullName email");
...
exports.updateContribution = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error updating contribution." });
    }
};
...
exports.deleteContribution = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error deleting contribution." });
    }
};
