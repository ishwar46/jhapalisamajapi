...
exports.getDocumentPage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error fetching documents page." });
    }
};
...
exports.updateDocumentPage = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error updating documents page." });
    }
};
...
exports.addDocumentItem = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error adding document item." });
    }
};
...
exports.updateDocumentItem = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error updating document item." });
    }
};
...
exports.deleteDocumentItem = async (req, res) => {
    try {
        ...
        return res.status(500).json({ error: "Server error deleting document item." });
    }
};
